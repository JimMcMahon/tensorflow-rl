...
def get_config():
    ...
    parser.add_argument('--replay_size', default=500000, type=int, help='Maximum capacity of replay memory', dest='replay_size')
    parser.add_argument('--replay_init_size', default=20000, type=int, help='Initial capacity of replay memory', dest='replay_init_size')
